...
class BaseAxes:
    ...
    def add_object_bounds(
        self, bounds: tuple[float64, float64, float64, float64]
    ): ...
    def draw_2d(
        self,
...
class CutAxes:
    def draw_position(
        self, size: int, bg_color: str, decimals: int | bool = ..., **kwargs
    ): ...
    def transform_to_2d(
        self, data: MaskedArray | ndarray | None, affine: ndarray
    ) -> MaskedArray | ndarray: ...
...
class GlassBrainAxes:
    ...
    def transform_to_2d(
        self, data: MaskedArray, affine: ndarray
    ) -> MaskedArray: ...
